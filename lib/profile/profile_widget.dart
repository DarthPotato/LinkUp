                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      controller:
                                          _model.careerFieldTextController,
                                      ...
                                      enableInteractiveSelection: true,
                                      validator: _model
                                          .careerFieldTextControllerValidator
                                          .asValidator(context),
                                    ),
                                  ),
                                ),
                                  ...
                                  child: FFButtonWidget(
                                    ...
                                    onPressed: () async {
                                      ...
                                      if (selectedFiles != null) {
                                        safeSetState(() => _model
                                                .isDataUploading_uploadedResume =
                                            true);
                                        ...
                                        try {
                                          ...
                                          ScaffoldMessenger.of(context)
                                              .hideCurrentSnackBar();
                                          _model.isDataUploading_uploadedResume =
                                              false;
                                        }
                                      ...
                                      logFirebaseEvent(
                                          'resumeButton_backend_call');

                                      await currentUserReference!
                                          .update(createUsersRecordData(
                                        resume: _model
                                            .uploadedFileUrl_uploadedResume,
                                      ));
                                      if (_model
                                          .isDataUploading_uploadedResume) {
                                        logFirebaseEvent(
                              ...
                              Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    ...
                                    onPressed: () async {
                                      logFirebaseEvent(
                                          'PROFILE_PAGE_profileButton_ON_TAP');
                                      logFirebaseEvent(
                                          'profileButton_backend_call');

                                      await currentUserReference!
                                          .update(createUsersRecordData(
                                        displayName:
                                            _model.nameFieldTextController.text,
                                        careerInterest: _model
                                            .careerFieldTextController.text,
                                      ));
                                      logFirebaseEvent(
                                          'profileButton_navigate_to');
